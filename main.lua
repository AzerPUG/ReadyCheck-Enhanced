...
function addonMain:BuildReadyCheckFrame()
    CreateFrame("Frame", "ReadyCheckCustomFrame", UIParent, "BackdropTemplate")
    ReadyCheckCustomFrame:SetPoint("CENTER")
    ReadyCheckCustomFrame:SetSize(400, 225)
    ReadyCheckCustomFrame.Consumables = CreateFrame("Frame", nil, ReadyCheckCustomFrame, "BackdropTemplate")
    ReadyCheckCustomFrame.Consumables:SetSize(195, 80)
    ReadyCheckCustomFrame.Consumables:SetPoint("TOPLEFT", 5, -30)
    ReadyCheckCustomFrame.Consumables.Title = ReadyCheckCustomFrame.Consumables:CreateFontString(nil, "ARTWORK", "GameFontNormal")
    ReadyCheckCustomFrame.Consumables.Title:SetText("Consumables")
    ReadyCheckCustomFrame.Consumables.Title:SetSize(195, 15)
    ReadyCheckCustomFrame.Consumables.Title:SetPoint("TOPLEFT", 0, -3)
    ReadyCheckCustomFrame.Consumables.Content = ReadyCheckCustomFrame.Consumables:CreateFontString("ReadyCheckConsumablesText", "ARTWORK", "GameFontNormalLarge")
    ReadyCheckCustomFrame.Consumables.Content:SetSize(190, 65)
    ReadyCheckCustomFrame.Consumables.Content:SetPoint("TOPLEFT", 5, -15)
    ReadyCheckCustomFrame.Consumables.Content:SetJustifyH("LEFT")
    ...
    ReadyCheckCustomFrame.RaidBuffs:SetPoint("TOPRIGHT", -5, -30)
    ...
    ReadyCheckCustomFrame.RaidBuffs.Content = ReadyCheckCustomFrame.RaidBuffs:CreateFontString("ReadyCheckRaidBuffText", "ARTWORK", "GameFontNormalLarge")
    ...
    ReadyCheckCustomFrame.GearBuffs = CreateFrame("Frame", nil, ReadyCheckCustomFrame, "BackdropTemplate")
    ReadyCheckCustomFrame.GearBuffs:SetSize(195, 80)
    ReadyCheckCustomFrame.GearBuffs:SetPoint("TOPLEFT", ReadyCheckCustomFrame.Consumables, "BOTTOMLEFT")
    ReadyCheckCustomFrame.GearBuffs.Title = ReadyCheckCustomFrame.GearBuffs:CreateFontString(nil, "ARTWORK", "GameFontNormal")
    ReadyCheckCustomFrame.GearBuffs.Title:SetText("Gear Buffs")
    ReadyCheckCustomFrame.GearBuffs.Title:SetSize(195, 15)
    ReadyCheckCustomFrame.GearBuffs.Title:SetPoint("TOPLEFT", 0, -3)
    ReadyCheckCustomFrame.GearBuffs.Content = ReadyCheckCustomFrame.GearBuffs:CreateFontString("ReadyCheckGearBuffsText", "ARTWORK", "GameFontNormalLarge")
    ReadyCheckCustomFrame.GearBuffs.Content:SetSize(190, 65)
    ReadyCheckCustomFrame.GearBuffs.Content:SetPoint("TOPLEFT", 5, -15)
    ReadyCheckCustomFrame.GearBuffs.Content:SetJustifyH("LEFT")
    ReadyCheckCustomFrame.GearInfo = CreateFrame("Frame", nil, ReadyCheckCustomFrame, "BackdropTemplate")
    ReadyCheckCustomFrame.GearInfo:SetSize(195, 80)
    ReadyCheckCustomFrame.GearInfo:SetPoint("TOPRIGHT", ReadyCheckCustomFrame.RaidBuffs, "BOTTOMRIGHT")
    ReadyCheckCustomFrame.GearInfo.Title = ReadyCheckCustomFrame.GearInfo:CreateFontString(nil, "ARTWORK", "GameFontNormal")
    ReadyCheckCustomFrame.GearInfo.Title:SetText("Gear Information")
    ReadyCheckCustomFrame.GearInfo.Title:SetSize(195, 15)
    ReadyCheckCustomFrame.GearInfo.Title:SetPoint("TOPLEFT", 0, -3)
    ReadyCheckCustomFrame.GearInfo.Content = ReadyCheckCustomFrame.GearInfo:CreateFontString("ReadyCheckGearInfoText", "ARTWORK", "GameFontNormalLarge")
    ReadyCheckCustomFrame.GearInfo.Content:SetSize(190, 65)
    ReadyCheckCustomFrame.GearInfo.Content:SetPoint("TOPLEFT", 5, -15)
    ReadyCheckCustomFrame.GearInfo.Content:SetJustifyH("LEFT")
    addonMain:SetBackDrop(ReadyCheckCustomFrame)
    addonMain:SetBackDrop(ReadyCheckCustomFrame.Consumables)
    addonMain:SetBackDrop(ReadyCheckCustomFrame.RaidBuffs)
    addonMain:SetBackDrop(ReadyCheckCustomFrame.GearBuffs)
    addonMain:SetBackDrop(ReadyCheckCustomFrame.GearInfo)
...
function AZP.IU.OnLoad:ReadyCheck(self)
    ...
    addonMain:BuildReadyCheckFrame()
